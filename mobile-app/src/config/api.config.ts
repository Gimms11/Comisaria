...
export const API_CONFIG = {
  ...
  GATEWAY_BASE_URL: `${Env.MS01_URL}/api/v1`,

  // MS-02: Denuncias Anónimas
  CRIME_REPORTS_BASE_URL: `${Env.MS02_URL}/api/v1`,

  // MS-03: Reportes Comunitarios
  COMMUNITY_REPORTS_BASE_URL: `${Env.MS03_URL}/api/v1`,

  // MS-04: Guías y Biblioteca TikTok
  GUIDES_BASE_URL: `${Env.MS04_URL}/api/v1`,
